 ...
 *
 */
public class ServiceMLImporter {
	 ...
	 */
	public ServiceMLImporter (Diagram diagram, ServletContext context) {
	...
	public File toSoaMLProfileXMI () throws IOException, FileNotFoundException {
		...
		transformedElements = new HashMap<String, ServiceMLImporter.Traceability>();
