 ...
 *
 */
public class ServiceMLExporter {
	 ...
	 */
	public ServiceMLExporter (Diagram diagram, ServletContext context) {
	...
	public File toSoaMLProfileXMI () throws IOException, FileNotFoundException {
		...
		transformedElements = new HashMap<String, ServiceMLExporter.Traceability>();
